...
'''
This code is modified to run n times the experiments and 
to take the mean (and the standard deviation) of the n results
'''
...
if __name__ == "__main__":
    ...
    ########################################################################
    # TRAIN A SIMULATOR FOR THE MOVIELENS DATASET
    # ----------------------------------------------------------------------
    ...
    if os.path.exists(simulator_path):
        ...
        simulator.train()
        print("--------------------------------------------------")
        print("TRAIN A SIMULATOR FROM MOVIELENS DATASET", "\n")
    ...
    ########################################################################
    # GENERATE A SYNTHETIC (FULL?) DATASET WITH THE SIMULATOR
    # ----------------------------------------------------------------------
    # create a torch dataset class that adopt the simulator and generate 
    ...
    for i in range(args.n):
        ...
        ####################################################################################
        # BUILD A BANDIT DATASET (SEE PAPER) AND TRAIN A RANKING MODEL (RANKER) FOR THE 
        ...
        for epoch in range(20):
            ...
            with torch.no_grad():
                ...
                two_stage_results = ev.two_stage_ranking_eval(logits, ranker, val_user_list)
                ...
                two_stage_results = ev.two_stage_ranking_eval(logits, ranker, test_user_list)
